    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(MyWriteActivity.this, adapterView.getItemAtPosition(i)+ "뿅", Toast.LENGTH_SHORT).show();

                // 게시물의 번호와 userid를 가지고 DetailActivity 로 이동
                //Intent intent = new Intent(MyWriteActivity.this, WiteViewActivity.class);
        ...
        MyWriteActivity.GetBoard getBoard = new MyWriteActivity.GetBoard();
        getBoard.execute();
    }
    ...
    class GetBoard extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter<String>(MyWriteActivity.this, android.R.layout.simple_list_item_1, titleList);
        ...
        protected String doInBackground(String... params) {
            ...
            String server_url = "http://172.20.10.8:821/mywriting/load_title/" + userid;
